...
data <- data[LotArea < 25000 & BldgArea < 25000]
...
- The linear model was the best performing out of all. The parameter *oneSE* in selectionFunction if added, it chooses the simplest model within one standard error of the best performance to be the optimal model.
