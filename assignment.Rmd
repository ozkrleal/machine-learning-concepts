...
#skimr::skim(data[LotArea < 25000 & BldgArea < 25000])
...
2- Create a training and a test set, assigning 70% of observations to the training set.
...
It seems the RMSE doesn't change with different regularization parameters for LASSO
...
```{r}
set.seed(857)
lm_fit_pca <- train(logTotalValue ~ . , 
                    data = data, 
                    method = "lm", 
...
With a .613821 RMSE Lasso with oneSE proved to be the best model for this exercise.
